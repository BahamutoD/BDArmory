        ...
        void FixedUpdate()
        {
            ...
            if (Time.time - flareTurbTimer > flareTurbDelta)
            {
                ...
                if (flareTurbulenceX >= 1) flareTurbulenceX = Mathf.Clamp(1 - UnityEngine.Random.Range(0f, 2f), 0, 1);
                    ...
                    flareTurbulenceX = Mathf.Clamp(-1 + UnityEngine.Random.Range(0f, 2f), -1, 1);
                ...
                if (flareTurbulenceY >= 1) flareTurbulenceY = Mathf.Clamp(1 - UnityEngine.Random.Range(0f, 2f), 0, 1);
                    ...
                    flareTurbulenceY = Mathf.Clamp(-1 + UnityEngine.Random.Range(0f, 2f), -1, 1);
                ...
                if (flareTurbulenceZ >= 1) flareTurbulenceZ = Mathf.Clamp(1 - UnityEngine.Random.Range(0f, 2f), 0, 1);
                    ...
                    flareTurbulenceZ = Mathf.Clamp(-1 + UnityEngine.Random.Range(0f, 2f), -1, 1);
            ...
            flareTurbulence = Vector3.Lerp(flareTurbulence,
                ...
                UnityEngine.Random.Range(2.5f, 7.5f)*TimeWarp.fixedDeltaTime);
