...
namespace BahaTurret
{
    public class BDModularGuidance : PartModule
    {
        ...
        [KSPField(isPersistant = true)] public int guidanceMode = 1;

        [KSPField(guiActive = true, guiName = "Guidance Type ", guiActiveEditor = true)] public string guidanceLabel =
            "AAM";
        ...
        public void StartGuidance()
        {
            ...
            else if (parentVessel != null && parentVessel.targetObject != null &&
                     parentVessel.targetObject.GetVessel() != null)
            {
        ...
        {
            if (guidanceActive && targetVessel != null && vessel != null && vesselTransform != null &&
                velocityTransform != null)
            {
                ...
                if (guidanceMode == 1)
                {
                    targetPosition = MissileGuidance.GetAirToAirTarget(targetPosition, vessel.srf_velocity,
                        vessel.acceleration, vessel, out timeToImpact);
                }
