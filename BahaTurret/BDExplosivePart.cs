...
namespace BahaTurret
{
    ...
    {
        [KSPField(isPersistant = false)] public float blastRadius = 50;
        [KSPField(isPersistant = false)] public float blastPower = 25;
        ...
        public void Detonate()
        {
            if (!hasDetonated)
            {
                ...
                ExplosionFX.CreateExplosion(position, blastRadius, blastPower, blastHeat, vessel,
                    FlightGlobals.getUpAxis(), "BDArmory/Models/explosion/explosionLarge", "BDArmory/Sounds/explode1");
            }
        }
    }
}