...
namespace BDArmory.UI
{
    ...
    public class BDAEditorCategory : MonoBehaviour
    {
        ...
        public static readonly Dictionary<string, string> CategoryIcons = new Dictionary<string, string>
        {
            ...
            {"Control", "BDArmory/Textures/icon"},
            {"Guns", "BDArmory/Textures/icon"},
            {"Gun turrets", "BDArmory/Textures/icon"},
            {"Laser turrets", "BDArmory/Textures/icon"},
            {"Rocket pods", "BDArmory/Textures/Rocket"},
            {"Rocket turrets", "BDArmory/Textures/RocketTurret"},
            {"Missiles", "BDArmory/Textures/icon"},
            {"Missile turrets", "BDArmory/Textures/icon"},
            {"Bombs", "BDArmory/Textures/icon"},
            {"Ammo", "BDArmory/Textures/icon"},
            {"Radars", "BDArmory/Textures/icon"},
            {"Countermeasures", "BDArmory/Textures/icon"},
            {"Armor", "BDArmory/Textures/icon"},
            {"Misc", "BDArmory/Textures/icon"},
